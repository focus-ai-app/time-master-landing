...
import { getStoreLinks } from "@/lib/lead";
import { Link } from "react-router-dom";

const Footer = () => {
  const { appStore, googlePlay } = getStoreLinks();
  return (
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Интеллектуальный помощник, который помогает ставить достижимые цели, блокирует отвлекающие приложения и подбирает полезный контент.
            </p>
          </div>
          ...
          <div className="grid gap-4">
            <div>
              ...
              <ul className="space-y-2 text-muted-foreground">
                ...
                <li><a href="#pricing" className="hover:text-primary transition-smooth">Тарифы</a></li>
            ...
            <div>
              <h4 className="font-semibold mb-3">Связаться</h4>
              <ul className="space-y-2 text-muted-foreground">
                <li className="flex items-center gap-2">
                  <Mail className="w-4 h-4" />
                  <a href="mailto:hello@focus.app" className="hover:text-primary transition-smooth">
                    hello@focus.app
                  </a>
                </li>
                <li className="flex items-center gap-2">
                  <MessageCircle className="w-4 h-4" />
                  <a href="#contact-form" className="hover:text-primary transition-smooth">
                    Оставить заявку
                  </a>
                </li>
              </ul>
        ...
        <div className="flex flex-wrap gap-4 justify-center py-8 border-t border-border">
          <Button
            ...
            asChild
          >
            <a href={appStore || "#"} target="_blank" rel="noopener noreferrer" aria-disabled={!appStore}>
          ...
          <Button
            ...
            asChild
          >
            <a href={googlePlay || "#"} target="_blank" rel="noopener noreferrer" aria-disabled={!googlePlay}>
            <div className="flex items-center gap-3">
              <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
